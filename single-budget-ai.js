 ...
 * - REAL Kraken WebSocket market data (24 markets!)
 * - Whale tracking & trader pattern recognition
 * - Fee-aware: Only sells with NET profit after 0.52% fees
 * - Auto-discovers best trading opportunities
 * - Compounds profits automatically
 * - Full state persistence (never loses progress)
 */
